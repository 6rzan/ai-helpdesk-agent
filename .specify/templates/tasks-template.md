...
> **NOTE: For safety-critical components, write these tests FIRST and ensure they FAIL before implementation**
...
- Tests for safety-critical components MUST be written and FAIL before implementation; all other tests ship in the same story
