...
function detectCategoryKeyword(text: string): IssueCategory | null {
...
async function startGuidedFlowForTicket(
  ctx: ReplyContext,
...
async function tryHandleGuidedReply(ctx: ReplyContext, resumedTicketIds: Set<string>): Promise<boolean> {
