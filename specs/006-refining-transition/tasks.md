...
- [ ] T016 [US1] Walk the full cross-feature journey by hand on the demo machine in one continuous run and record the date, each stage's outcome, and the run's overall verdict in `docs/testing/demo-path-runs/` (FR-001, spec AS1-1)
...
- [ ] T019 [US1] Run all five `specs/003-guided-troubleshooting/quickstart.md` scenarios manually on the demo machine and record each walkthrough's outcome in `docs/testing/quickstart-walkthroughs-003.md` (FR-003, closes 003 T047)
- [ ] T020 [US1] Mark T047 `[X]` in `specs/003-guided-troubleshooting/tasks.md`, citing `docs/testing/quickstart-walkthroughs-003.md` as its artifact
